/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 26513821f87eb9a5b13eb3a3aa76c004)
...
interface __BaseEnv_Env {
	...
	QUERY_ENGINE: Fetcher /* rundown-query-preview */ | Fetcher /* rundown-query */;
}
declare namespace Cloudflare {
	...
	interface PreviewEnv {
		...
		CLERK_SECRET_KEY: string;
		QUERY_ENGINE: Fetcher /* rundown-query-preview */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ACCOUNT_ID" | "R2_BUCKET_NAME" | "DATA_SOURCE_BASE_URL" | "CLERK_SECRET_KEY">> {}
}
