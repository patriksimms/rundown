/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3e90e2d36dd68c31b87c020c126882ee)
// Runtime types generated with workerd@1.20260828.1 2026-08-29 nodejs_compat
interface __BaseEnv_Env {
	QUERY_CACHE: KVNamespace;
	DATA: R2Bucket;
	DB: D1Database;
	CLOUDFLARE_ACCOUNT_ID: "17c619232f5d84567cd69896e892f326";
	R2_BUCKET_NAME: "rundown-data-preview" | "rundown-data";
	DATA_SOURCE_BASE_URL: "r2://rundown-data-preview" | "r2://rundown-data";
	QUERY_DATA_SOURCE_BASE_URL: "r2://rundown-data-preview" | "r2://rundown-data";
	CLERK_SECRET_KEY: string;
	R2_ACCESS_KEY_ID: string;
	R2_SECRET_ACCESS_KEY: string;
	QUERY_ENGINE: DurableObjectNamespace<import("./src/server").QueryEngineContainer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "QueryEngineContainer";
	}
	interface PreviewEnv {
		...
		DB: D1Database;
		CLOUDFLARE_ACCOUNT_ID: "17c619232f5d84567cd69896e892f326";
		R2_BUCKET_NAME: "rundown-data-preview";
		DATA_SOURCE_BASE_URL: "r2://rundown-data-preview";
		QUERY_DATA_SOURCE_BASE_URL: "r2://rundown-data-preview";
		CLERK_SECRET_KEY: string;
		R2_ACCESS_KEY_ID: string;
		R2_SECRET_ACCESS_KEY: string;
		QUERY_ENGINE: DurableObjectNamespace<import("./src/server").QueryEngineContainer>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ACCOUNT_ID" | "R2_BUCKET_NAME" | "DATA_SOURCE_BASE_URL" | "QUERY_DATA_SOURCE_BASE_URL" | "CLERK_SECRET_KEY" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY">> {}
}
