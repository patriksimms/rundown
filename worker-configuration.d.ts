/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 007bbb799c7bc092d2901784cc3bb78f)
...
interface __BaseEnv_Env {
  ...
  QUERY_CACHE_NAME: 'rundown-query-cache-preview' | 'rundown-query-cache';
  ...
  INTERNAL_R2_SIGNING_SECRET: string;
  UPLOAD_SIGNING_SECRET: string;
  RESET_ADMIN_TOKEN: string;
...
declare namespace Cloudflare {
  ...
  interface PreviewEnv {
    ...
    PRODUCT_ANALYTICS: AnalyticsEngineDataset;
    APP_ENV: 'preview';
    QUERY_CACHE_NAME: 'rundown-query-cache-preview';
    CLOUDFLARE_ACCOUNT_ID: '17c619232f5d84567cd69896e892f326';
